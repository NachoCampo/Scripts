...
SELECT
    ...
    FORMAT(CAST(CUMPLEANIO AS DATE), 'dd/MM/yyyy') AS [FECHA DE CUMPLEAÑOS], --REPLACE(CONVERT(VARCHAR(10), CUMPLEANIO, 103), '/', '-') AS [FECHA DE CUMPLEAÑOS], -- Formatear como DD-MM-YYYY
