...
SELECT     
 ...
 AC.COD_STA11 AS [Artículo], --Artículo que interviene en la factura.  
  ...
  JOIN CUENTA ON AC1.ID_CUENTA_VENTAS = CUENTA.ID_CUENTA  
   WHERE AC1.COD_STA11 = AC.COD_STA11) AS [Seccion],   -- Esto sale de la cuenta contable del artículo.    
    ...
    CASE  
        ...
        ELSE CAST(SBA05.COD_CTA AS INT)  
           END AS [Cuenta Fondos], -- Ajustado a INT (Entero)   
    CASE  
        ...
        ELSE SBA01.DESCRIPCIO  
           END AS [Nombre de Cuenta Fondos],    
