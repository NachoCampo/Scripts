...
SELECT 
    ...
    CASE GVA21.ESTADO WHEN 1 THEN 'INGRESADO' WHEN 2 THEN  'PENDIENTE' WHEN 3 THEN 'FACTURADO' WHEN 4 THEN 'CERRADO' WHEN 5 THEN 'ANULADO' WHEN 6 THEN 'REVISADO'	WHEN 7 THEN 'DESAPROBADO' ELSE '' END AS [Estado] , --Se cambian los estados de los pedidos según query original
    --GVA03.COD_ARTICU AS [Cód. Artículo] ,
	GVA55.N_COMP AS [Número de Factura],
    CONCAT(
        GVA21.LEYENDA_2,
        GVA21.LEYENDA_3,
        GVA21.LEYENDA_4,
...
WHERE 
   ...
   -- ( (GVA21.FECHA_PEDI BETWEEN '01/09/2023' AND '30/09/2023')) AND GVA03.RENGL_PADR = 0
     (GVA14.CAMPOS_ADICIONALES IS NULL OR GVA14.CAMPOS_ADICIONALES.exist('/CAMPOS_ADICIONALES/CA_PRIORIDAD') = 1)
	--Falta filtrar por talonario de incidencias
	And GVA21.TALON_PED = '40'